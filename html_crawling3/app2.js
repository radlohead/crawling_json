...
//                 let app = $.html();
//                 let str = $(app).find('.box_flip:first-child .table:nth-child(2) thead th:first-child').text();
//                 json[num]["가맹본부의 일반 현황"][0]["가맹본부 일반 현황"][str] = num;
//                 console.log(num);
//                 next();
//             }
//         });
...
for(let num=0; num<urls.length; num++){
    app.use((req, res, next) => {
        client.fetch(urls[num], {q: 'node.js'}, (err, $, res, body) => {
            if($){
                json.push({
                    "가맹본부의 일반 현황": [{
                        "가맹본부 일반 현황": {
