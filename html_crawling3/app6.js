...
if(cluster.isMaster){
                ...
                if($) {
                    ...
                    class Crawling {
                        ...
                        generalPresent__4() {
                            ...
                            temp__td.push($(`.box_flip:nth-child(1) .table:nth-child(3) tr:nth-child(1) td.cell_left`).text().replace(/(\s*)/g, ''));
                            temp__td.push($(`.box_flip:nth-child(1) .table:nth-child(3) tr:nth-child(2) td.cell_left:nth-child(2)`).text().replace(/(\s*)/g, ''));
                            temp__td.push($(`.box_flip:nth-child(1) .table:nth-child(3) tr:nth-child(2) td.cell_left:nth-child(4)`).text().replace(/(\s*)/g, ''));
                            temp__td.push($(`.box_flip:nth-child(1) .table:nth-child(3) tr:nth-child(2) td.cell_left:nth-child(6)`).text().replace(/(\s*)/g, ''));
    ...
    app.get('/', (req, res) => {
        fs.writeFile('./data/data_5001~5780.json', JSON.stringify(json, null, "\t"), (err) => {
